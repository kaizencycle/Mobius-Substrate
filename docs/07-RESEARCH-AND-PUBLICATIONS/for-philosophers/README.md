...
| Looking for... | Go to... |
|----------------|----------|
| ⚖️ Ethical foundations | [ETHICAL-FOUNDATIONS/](./ETHICAL-FOUNDATIONS/) |
| 🏛️ Governance theory | [GOVERNANCE-PHILOSOPHY/](./GOVERNANCE-PHILOSOPHY/) |
| ☯️ Self-improving ethics | [RECURSIVE-ETHICS/](./RECURSIVE-ETHICS/) |
...
**Path:** [ETHICAL-FOUNDATIONS/virtue-accords/](./ETHICAL-FOUNDATIONS/virtue-accords/)
...
**Path:** [ETHICAL-FOUNDATIONS/social-contract/](./ETHICAL-FOUNDATIONS/social-contract/)
...
**Path:** [ETHICAL-FOUNDATIONS/global-justice/](./ETHICAL-FOUNDATIONS/global-justice/)
...
**Path:** [ETHICAL-FOUNDATIONS/kintsugi-principle/](./ETHICAL-FOUNDATIONS/kintsugi-principle/)
...
- Ledger inscriptions for system failures
- Version history as institutional memory
- Recovery protocols as growth catalysts
...
**Path:** [GOVERNANCE-PHILOSOPHY/democratic-virtual-architecture/](./GOVERNANCE-PHILOSOPHY/democratic-virtual-architecture/)
...
**Path:** [GOVERNANCE-PHILOSOPHY/consensus-protocols/](./GOVERNANCE-PHILOSOPHY/consensus-protocols/)
...
**Path:** [GOVERNANCE-PHILOSOPHY/tri-sentinel-governance/](./GOVERNANCE-PHILOSOPHY/tri-sentinel-governance/)
...
**Path:** [EXISTENTIAL-RISK/alignment-problem/](./EXISTENTIAL-RISK/alignment-problem/)
...
**Path:** [EXISTENTIAL-RISK/sml-safety-proofs/](./EXISTENTIAL-RISK/sml-safety-proofs/)

Formal verification of alignment:

1. **Drift prevention** — 97% reduction in value deviation
2. **Integrity gates** — MII ≥ 0.95 for all actions
3. **Human anchoring** — Daily reflection requirements
4. **Bounded learning** — Constrained update regions

---

### Substrate Integrity

**Path:** [EXISTENTIAL-RISK/substrate-integrity/](./EXISTENTIAL-RISK/substrate-integrity/)
...
**Path:** [PEACE-STUDIES/](./PEACE-STUDIES/)
...
**Ethics researcher?**
Review our frameworks and propose improvements.

**Political philosopher?**
Analyze our governance models.
...
- **Policy implementation** → [FOR-GOVERNMENTS/](../FOR-GOVERNMENTS/)
- **Technical implementation** → [sentinels/](../sentinels/)
