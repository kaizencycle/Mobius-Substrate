...
```
        ...
        │                    │                    │
   ┌────▼────┐          ┌────▼────┐          ┌────▼────┐
   │DVA.FULL │          │DVA.FULL │          │DVA.FULL │
   │ Region A│          │ Region B│          │ Region C│
   └────┬────┘          └────┬────┘          └────┬────┘
        │                    │                    │
   ┌────┴────┐          ┌────┴────┐          ┌────┴────┐
   │ DVA.ONE │          │ DVA.ONE │          │ DVA.ONE │
   │  Nodes  │          │  Nodes  │          │  Nodes  │
   └────┬────┘          └────┬────┘          └────┬────┘
        │                    │                    │
   ┌────▼────┐          ┌────▼────┐          ┌────▼────┐
   │DVA.LITE │          │DVA.LITE │          │DVA.LITE │
...
See: [MIC Whitepaper v2.0](./MIC_Whitepaper_v2.0.md) for detailed consensus specifications.

### C. Failure-State Simulation

See: [Carrington Event Failure Model](../../simulations/carrington-event-failure-model.md)
...
**Version History:**
- v1.0 (C-155): Initial publication
