---
doc_id: INDEX-ROOT-2025-001
title: "Mobius Systems Documentation — Master Entry Point"
...
abstract: >
  The single point of entry for all Mobius Systems documentation. Designed for
  developers, users, elders, philosophers, researchers, and all who seek to
  understand and contribute to the world's first KTT-native operating system.
license: CC-BY-SA-4.0
---

# 🌀 Mobius Systems Documentation Portal
## Master Entry Point — One Source of Truth
...
All documents follow a Dewey Decimal-inspired classification:

- **000** - Meta-Documentation (indices, navigation, system docs)
- **100** - Introduction (getting started, handbooks)
...
**See**: [Master Index](./00-META/MASTER_INDEX.md) for complete classification

---

## 🔍 Finding Documents

### Method 1: Master Index
👉 **[MASTER_INDEX.md](./00-META/MASTER_INDEX.md)** — Complete catalog of all documents

### Method 2: Subject Index
👉 **[SUBJECT_INDEX.md](./00-META/SUBJECT_INDEX.md)** — Browse by topic/keyword

### Method 3: Navigation Guide
👉 **[NAVIGATION_GUIDE.md](./00-META/NAVIGATION_GUIDE.md)** — How to navigate the docs

### Method 4: LaTeX Index
...
- 🛠️ **Technical**: support@mobius.systems
- 🏛️ **Governance**: governance@mobius.systems
...
- **Doc ID**: Unique identifier (e.g., `WP-2025-001`)
- **Classification**: Dewey-inspired number (000-900)
- **Version**: Semantic versioning
- **Status**: Published, Draft, Archived
- **Keywords**: For searchability
- **Abstract**: Brief summary

**See**: [Master Index](./00-META/MASTER_INDEX.md) for complete metadata
...
- [BYLAWS.md](../FOUNDATION/BYLAWS.md)
- [GOVERNANCE.md](../FOUNDATION/GOVERNANCE.md)

### Policies
- [Anti-Capture Policy](../FOUNDATION/POLICIES/ANTI_CAPTURE_POLICY.md)
- [Code of Conduct](../FOUNDATION/POLICIES/CODE_OF_CONDUCT.md)
- [Security Policy](../FOUNDATION/POLICIES/SECURITY.md)

### Process
- [RFC Process](../FOUNDATION/PROCESS/RFC_PROCESS.md)
- [Versioning](../FOUNDATION/PROCESS/VERSIONING.md)
...
- ✅ Distributed sovereignty (Two-house + AI Sentinels)
...
**Status**: Published  
**License**: CC-BY-SA-4.0  
**Document ID**: INDEX-ROOT-2025-001
